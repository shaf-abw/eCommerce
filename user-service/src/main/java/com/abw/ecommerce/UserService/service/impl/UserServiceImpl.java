...
import com.abw.ecommerce.UserService.event.EventProducer;
import com.abw.ecommerce.UserService.exception.wrapper.*;
import com.abw.ecommerce.UserService.model.dto.request.*;
...
public class UserServiceImpl implements UserService {
    ...
    public Mono<String> refreshToken(String refreshToken) {
        return webClientBuilder.build()
                ...
                .retrieve()
                .onStatus(HttpStatusCode::is4xxClientError, clientResponse -> Mono.error(new IllegalArgumentException("Refresh token không hợp lệ")))
